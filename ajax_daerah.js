...
function ajaxkota(id){
  var url="http://localhost/ithb/daerah/getKab/"+id+"/"+Math.random();
...
function ajaxkec(id){
  var url="http://localhost/ithb/daerah/getKec/"+id+"/"+Math.random();
...
function ajaxkel(id){
  var url="http://localhost/ithb/daerah/getKel/"+id+"/"+Math.random();
