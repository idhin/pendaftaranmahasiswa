                ...
                <div class="row align-items-center justify-content-center h-100">
                    <div class="col-12">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <img src="<?= base_url(); ?>assets/images/login/mail.png" class="img-fluid" width="80" alt="">
                                <h2 class="mt-3 mb-0">Pendaftaran Berhasil !</h2>
                                ...
                                <p class="cnf-mail mb-1">Terimakasih telah mendaftar, mohon ditunggu informasi berikutnya.</p>
                                <div class="d-inline-block w-100">
                                    <a class="btn btn-primary mt-3" href="<?= base_url(); ?>">Kembali ke Situs Utama<em></em></a>
                                </div>
                            </div>
                        </div>
                    </div>
